 ...
 */
final class Version20220821215736 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE movie ADD description VARCHAR(4096) NOT NULL');
        $this->addSql('ALTER TABLE series ADD description VARCHAR(4096) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE movie DROP description, CHANGE title title VARCHAR(255) CHARACTER SET utf8mb3 NOT NULL COLLATE `utf8mb3_unicode_ci`, CHANGE poster poster VARCHAR(32) CHARACTER SET utf8mb3 NOT NULL COLLATE `utf8mb3_unicode_ci`');
        ...
        $this->addSql('ALTER TABLE series DROP description, CHANGE title title VARCHAR(255) CHARACTER SET utf8mb3 NOT NULL COLLATE `utf8mb3_unicode_ci`, CHANGE poster poster VARCHAR(32) CHARACTER SET utf8mb3 NOT NULL COLLATE `utf8mb3_unicode_ci`');
